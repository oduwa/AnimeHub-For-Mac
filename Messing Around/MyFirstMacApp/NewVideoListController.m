...
#import "NewVideoListController.h"
#import "WebViewController.h"

@interface NewVideoListController (){
    NSXMLParser *parser;
...
@implementation NewVideoListController
...
- (void)viewDidLoad {
    ...
    NSURL *url = [NSURL URLWithString:@"http://www.nwanime.com/rss/new"];
