//
//  MostViewedVideoListController.m
//  MyFirstMacApp
//
...
#import "MostViewedVideoListController.h"
#import "WebViewController.h"

@interface MostViewedVideoListController (){
    NSXMLParser *parser;
...
@implementation MostViewedVideoListController
...
- (void)viewDidLoad {
    ...
    NSURL *url = [NSURL URLWithString:@"http://www.nwanime.com/rss/views"];
